...
define("APP_ID",         "20170518000048355"); //替换为您的APPID
define("SEC_KEY",        "i2cDIeJFAjN4rotoh2pr");//替换为您的密钥

 
 
 
//翻译入口
function baidu_translate($query, $from = 'auto', $to = 'cht')
{
    $args = array(
        'q' => $query,
        'appid' => APP_ID,
    ...
    $args['sign'] = baidu_buildSign($query, APP_ID, $args['salt'], SEC_KEY);
    $ret = baidu_call(URL, $args);
