...
<form id="setup" method="post" action="./index.php?met=createAdminAccount&language=zh_CN" novalidate="novalidate">
	<table class="form-table">
		<tr>
			...
			<td>
				<input name="user_account" value="admin"  type="text" id="user_login" size="25" value="admin"  style="width: 100%" />
				<p></p>
			</td>
		</tr>
		...
		<tr class="form-field form-required user-pass1-wrap">
			...
			<td>
				<div class="">
					<input type="text" name="ucenter_api_url" id="ucenter_api_url" class="regular-text"  value="<?=Yf_Registry::get('ucenter_api_url')?>"  style="width: 100%" />
					<div id="pass-strength-result" aria-live="polite"></div>
				</div>
				<p><span class="description important hide-if-no-js">
