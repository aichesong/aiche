    ...
    <div class="item-title">
      <div class="subject">
       ...
       <ul class="tab-base nc-row">
          <li><a class="current"><span>白条审核</span></a></li>
          <li><a href="index.php?ctl=Paycen_BtInfo&met=setBtLimit">白条信用额度设置</a></li>
          <li><a href="index.php?ctl=Paycen_BtInfo&met=setBtReturn">白条收款确认</a></li>
...
<script src="./admin/static/default/js/controllers/btinfo/btinfo_list.js"></script>
<?php
