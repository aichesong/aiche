...
class AopClient {
	...
	{
		$config = require APP_PATH . '/data/api/alipay/alipayMobileConfig.php';

		$this->appId = $config['appId'];
		$this->rsaPrivateKey = $config['rsaPrivateKey']; //请填写开发者私钥去头去尾去回车，一行字符串
		$this->alipayrsaPublicKey = $config['alipayrsaPublicKey'];//请填写支付宝公钥，一行字符串
		$this->format = "json";
		$this->charset = "UTF-8";
		$this->signType = "RSA2";
	}
