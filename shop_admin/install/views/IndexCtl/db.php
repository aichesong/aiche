...
<p id="logo"><a href="http://www.yuanfeng.cn" tabindex="-1">远丰电商</a></p>
<?php
$msg = '';
...
<form method="post" action="./index.php?met=initDbConfig&language=zh_CN">
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="prefix" id="prefix" type="text" value="<?php echo defined('TABEL_PREFIX') ? TABEL_PREFIX : 'yf_admin_';?>" size="25" /></td>
			<td>如果您希望在同一个数据库安装多个远丰电商，请修改前缀。</td>
		</tr>
	</table>
