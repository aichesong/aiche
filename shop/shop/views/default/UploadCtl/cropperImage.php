...
<head>
    <meta charset="UTF-8">
    <title>WebUploader<?=__('演示')?> - <?=__('带裁剪功能')?> </title>
...
<div class="modal-body">
    <div class="image-first js-origin-select">
        <div class="uploader-container">
            <div id="filePicker" style="top: 125px;"><?=__('选择文件')?></div>
        </div>
    </div>
</div>
...
<div id="wrapper" style="display: none">
    ...
    <div class="cropper-wraper webuploader-element-invisible">
        ...
        <div class="upload_div"><div class="upload-btn upload-btn2"><?=__('上传所选区域')?></div></div>
    </div>
