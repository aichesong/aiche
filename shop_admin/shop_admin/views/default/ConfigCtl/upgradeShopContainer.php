...
<div class="wrapper page">
    ...
    <iframe  style="width: 100%;height: 500px;border: 0" src="<?= Yf_Registry::get('url') ?>?ctl=Config&met=upgradeShop&upgrade=<?=request_int('upgrade', 0)?>&force-upgrade=<?=request_int('force-upgrade', 0)?>">
    </iframe>
