	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=update"><span>更新管理中心</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=updateUcenter"><span>更新用户中心</span></a></li>
			</ul>
		</div>
	</div>
