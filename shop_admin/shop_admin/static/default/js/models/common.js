...
Public.Tips.prototype = {
    ...
    _create : function(){
        ...
        if(opts.autoClose) {
            this.obj = $('<div class="ui-tips" style="width:130px;height:20px;padding:5px 30px;font-size:12px;border:1px solid;border-radius:2px"><i></i></div>').append(opts.content);
        } else {
