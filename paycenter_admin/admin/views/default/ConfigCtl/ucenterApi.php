  ...
  ?>
    ...
    <form method="post" id="ucenter-shop_api-setting-form" name="ucenterSettingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="site_name">Ucenter 后台URL</label>
                </dt>
                <dd class="opt">
                    <input id="ucenter_admin_url" name="ucenter_api[ucenter_admin_url]" value="<?=Yf_Registry::get('ucenter_admin_url')?>" class="ui-input w400" type="text"/>

                    <p class="notic">Ucenter后台地址</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
