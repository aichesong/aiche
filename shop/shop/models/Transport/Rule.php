...
/**
 * Description of Transport_Rule
 * 运费模板设置 basic model
 * @author Str <tech40@yuanfeng.cn>
 * @version    shop3.1.3
 * 
 */
class Transport_Rule extends Yf_Model
{
	public $_cacheKeyPrefix  = 'c|transport_rule|';
	public $_cacheName       = 'transport';
	public $_tableName       = 'transport_rule';
	 ...
	 * @access public
	 */
	public function getRule($id = null, $sort_key_row = null)
	{
	 ...
	 * @access public
	 */
	public function addRule($field_row, $return_insert_id = false)
	{
	 ...
	 * @access public
	 */
	public function editRule($id, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editRuleSingleField($id, $field_name, $field_value_new, $field_value_old)
	{
