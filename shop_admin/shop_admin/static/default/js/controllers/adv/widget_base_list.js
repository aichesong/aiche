...
function initGrid()
{
    var t = ["操作", "名称", "类型", "展示方式", "宽度/字数", "高度", "广告数", "正在展示", "是否启用"], e = [{
        ...
        {name: "widget_name", index: "widget_name", align: "center",width: 200},
        {name: "widget_type_name", index: "widget_type_name", width: 300},
        {name: "widget_display_type", index: "widget_display_type", width:150},
        {name: "widget_width", index: "widget_width", width:100},
        {name: "widget_height", index: "widget_height", width:100},
        {name: "widget_total", index: "widget_total", width:100},
        {name: "active_items_num", index: "active_items_num", width:100},
        {name: "widget_active_type", index: "widget_active_type", width:100}
    ];
