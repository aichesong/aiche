...
<div class="widget-attachment modal hide in" aria-hidden="false" style="display: block; top: 0px;border-style: none;">
	<div class="js-main-region">
  	...
  	<div class="modal-body" id="image-list">
		    ...
		    <div class="attachment-list-region js-attachment-list-region">
	            ...
	            <a href="javascript:;" class="ui-btn ui-btn-success js-show-upload-view bbc_seller_btns" style="position: absolute; left: 180px; bottom: 16px;"><?=__('上传图片')?></a>
            </div>
    ...
    <div class="network-image-region">
        <div class="title"><?=__('网络图片')?>：</div>
        <div class="content">
            <div class="input-append">
                <input type="text" placeholder="<?=__('请添加网络图片地址')?>" class="js-network-image-url span4">
                <button class="btn js-network-image-confirm"  type="button" data-loading-text="<?=__('提取中')?>..."><?=__('提取')?></button>
            </div>
    ...
    <div class="local-image-region">
        ...
        <div class="content">
            ...
            <div class="c-gray" style="clear: both; padding-top: 20px;">
				<?=__('支持')?>jpg、gif、png、jpeg、bmp<?=__('五种格式')?>, <?=__('大小不超过')?>2 MB
            </div>
        </div>
    </div>
</div>
...
<div class="modal-footer clearfix">
    <div class="text-center">
        <button class="ui-btn ui-btn-disabled js-confirm " disabled="disabled" data-loading-text="<?=__('正在上传')?>..."><?=__('确认')?></button>
    </div>
</div>
