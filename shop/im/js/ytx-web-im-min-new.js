(function (e)
{
    try
    {
        ...
        {
            document.write('<script type="text/javascript" src="./js/MD5.min.js"><\/script>')
        }
    } catch (e)
    {
        document.write('<script type="text/javascript" src="./js/MD5.min.js"><\/script>')
    ...
    try
    {
        ...
        {
            document.write('<script type="text/javascript" src="./js/base64.min.js"><\/script>')
        }
    } catch (e)
    {
        document.write('<script type="text/javascript" src="./js/base64.min.js"><\/script>')
    ...
    try
    {
        ...
        {
            document.write('<script type="text/javascript" src="./js/pako.js"><\/script>')
        }
    } catch (e)
    {
        document.write('<script type="text/javascript" src="./js/pako.js"><\/script>')
    ...
    var YTX_CONFIG = {
        ...
        _getServerIp: function (type, callback, onError, sig, timestamp, reset)
        {
            ...
            console.log( Base64.decode(YTX_CONFIG._app_server) + w + accunt + "/GetServerBalance" );
            ...
            $.ajax({
                ...
                error: function (e)
                {
                    console.log('get server failed, please check the parameter');
                    console.log(e)
                }
            })
        },
