...
$(document).ready(function(){
    ...
    $("#pay_btn").click(function(){
        ...
        $.ajax({
            ...
            data:{mob_phone:mob_phone,true_name:true_name,goods_id:goods_id,chain_id:chain_id,increase_goods_id:increase_goods_id,voucher_id:voucher_id,pay_way_id:pay_way_id,remarks:remarks},
            dataType: "json",
