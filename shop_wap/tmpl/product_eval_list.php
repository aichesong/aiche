    ...
    <% if (goods_eval_list.length > 0) { %>
        <ul>
            <% for (var i=0; i<goods_eval_list.length; i++) { var goods_eval = goods_eval_list[i][0]; %>
                <li>
                    <div class="eval-user">
                        <div class="user-avatar"><img src="<%=goods_eval.user_logo%>" /></div>
                        <span class="user-name"><%=goods_eval.user_name%></span>
                        <div class="goods-raty"><i class="star<%=goods_eval.scores%>"></i></div>
                        <time>
                        ...
                        <%if(goods_eval.image_row.length > 0) {%>
                            <dd class="goods_geval">
                                <%for (var j=0; j<goods_eval.image_row.length; j++) {%>
                                    <a href="javascript:void(0);"><img src="<%=goods_eval.image_row[j]%>" /></a>
                                    <%}%>
